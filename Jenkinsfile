pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-04-0296d3b61dfb"
        TF_VAR_bucket = "tf-remote-state-student_01_18295c720291-31365-939"
        REPOSITORY = "https://github.com/jonrad99/sample-awx-project"
